...
$(document).ready(function() {
	...
	for (i=0; i<24; i++) {
		...
		if (i==12) {
			$('#board').append("<div data-value='1' class='selected freesquare' id='sqfree'><span class='middle'>free space</span></div>");
			$('#board').append("<div data-value='0' class='square' id='sq12'><span class='middle'>"+JSONBingo.squares[i].square+"</span></div>");
		} else {
			$('#board').append("<div data-value='0' class='square' id='sq"+i+"'><span class='middle'>"+JSONBingo.squares[i].square+"</span></div>");
		}
	}
	...
	$('div.square').tappable(function () {
		...
		var summe = ($('#sq0').data('value')+$('#sq1').data('value')+$('#sq2').data('value')+$('#sq3').data('value')+$('#sq4').data('value')) + ($('#sq5').data('value')+$('#sq6').data('value')+$('#sq7').data('value')+$('#sq8').data('value')+$('#sq9').data('value')) + ($('#sq10').data('value')+$('#sq11').data('value')+$('#sqfree').data('value')+$('#sq12').data('value')+$('#sq13').data('value')) + ($('#sq14').data('value')+$('#sq15').data('value')+$('#sq16').data('value')+$('#sq17').data('value')+$('#sq18').data('value')) + ($('#sq19').data('value')+$('#sq20').data('value')+$('#sq21').data('value')+$('#sq22').data('value')+$('#sq23').data('value'));
		summe = 0;
